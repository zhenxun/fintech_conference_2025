...
function Submission() {
    const list=[
        'Submissions will be handled through the submission page on <a href="/login">2024 Annual Conference of Center for Innovative FinTech Business Models, NCKU</a>.',
