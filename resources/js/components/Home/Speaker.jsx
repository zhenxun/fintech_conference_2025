...
function Speaker() {
    ...
    return (
        <div style={{textAlign: 'justify',backgroundAttachment:'fixed',backgroundSize:'cover',backgroundRepeat:'no-repeat',backgroundImage:'url(/assets/bg1.jpg)'}} className='align-items-center' id='keynote-speaker'>
